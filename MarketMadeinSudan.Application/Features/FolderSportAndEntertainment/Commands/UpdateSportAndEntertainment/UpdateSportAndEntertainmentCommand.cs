...
namespace MarketMadeinSudan.Application.Features.FolderSportAndEntertainment.Commands.UpdateSportAndEntertainment
{
    public class UpdateSportAndEntertainmentCommand : IRequest
    {
        ...
        [Display(Name = "السعر"), MinLength(3)]

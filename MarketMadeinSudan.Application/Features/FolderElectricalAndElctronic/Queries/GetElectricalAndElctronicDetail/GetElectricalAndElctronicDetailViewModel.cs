using MarketMadeinSudan.Application.Features.FolderElectricalAndElctronic.Queries.GetElectricalAndElctronicList;
...
{
    public class GetElectricalAndElctronicDetailViewModel
    {
        public Guid ElectricalAndElctronicId { get; set; }
        [Display(Name = "الاسم"), MaxLength(30), MinLength(3)]
        public string ElectricalAndElctronicName { get; set; }
